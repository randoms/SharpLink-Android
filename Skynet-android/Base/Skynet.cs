...
namespace SkynetAndroid.Base
{
    ...
    public class SkynetAndroid
    {
        ...
        public static List<SkynetAndroid> allInstance = new List<SkynetAndroid>();

        public SkynetAndroid(string filename = "")
        {
            // init tox client
