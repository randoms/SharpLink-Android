...
namespace SharpLinkAndroid
{
    class LinkClient
    {
        ...
        public IPAddress ip;
        public int port;
        private SkynetAndroid.Base.SkynetAndroid mSkynet;
        ...
        private async Task<bool> HandShake()
        {
            ...
            Utils.Log("Event: Start Handshake, ReqId: " + reqid + ", ClientId: " + clientId, true);
            ...
            if (res == null)
            {
                Utils.Log("Event: Handshake Failed, ReqId: " + reqid + ", ClientId: " + clientId, true);
                return false;
            }
            else
            {
                Utils.Log("Event: Handshake Success, ReqId: " + reqid + ", ClientId: " + clientId, true);
        ...
        public bool Send(byte[] msg, int size)
        {
            ...
            var res = mSkynet.sendRequest(new ToxId(targetToxId), new ToxRequest
            {
                ...
                toToxId = targetToxId,
                toNodeId = serverId,
                time = SkynetAndroid.Utils.Utils.UnixTimeNow(),
